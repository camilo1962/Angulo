...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField]
    private TMP_Text _scoreText, _endScoreText,_highScoreText, recordJuego;
    ...
    private void Start()
    {
        ...
        recordJuego.text = PlayerPrefs.GetInt(Constants.DATA.HIGH_SCORE, 0).ToString();
